...
import { hideErrorDialog } from '../redux/actions';
...
const ApiAccess = ({ hideErrorDialog }) => {
    ...
    return (
      <React.Fragment>
        ...
        <p>
          ...
          ) using your API Access Client and how to use the access token to make authenticated CRT REST API requests.
        </p>
        ...
        <p>
          ...
          CRT API. To use the access token you simply need to set your <strong>Authorization</strong> header in your
  ...
  return (
    <MaterialCard>
      ...
      <p>
        An API Access Client is needed to obtain access to the CRT REST API.{' '}
