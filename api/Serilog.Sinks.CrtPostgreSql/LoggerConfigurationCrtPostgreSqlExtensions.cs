...
namespace Serilog.Sinks.CrtPostgreSql
{
    /// <summary>
    ...
    public static class LoggerConfigurationCrtPostgreSqlExtensions
    {
        /// <summary>
        ...
        [SuppressMessage(
            ...
            Justification = "Reviewed. Suppression is OK here.")]
        // ReSharper disable once UnusedMember.Global
        public static LoggerConfiguration CrtPostgreSql(
        ...
        private static string GetConnectionString(string nameOrConnectionString, IConfiguration appConfiguration)
        {
            ...
            {
                SelfLog.WriteLine("CrtPostgreSql sink configured value {0} is not found in ConnectionStrings settings and does not appear to be a raw connection string.", nameOrConnectionString);
            }
            return cs;
        }
    }
